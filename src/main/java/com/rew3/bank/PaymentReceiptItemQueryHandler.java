...
import com.rew3.payment.invoicepayment.model.PaymentReceipt;
...
public class PaymentReceiptItemQueryHandler implements IQueryHandler {
	...
	public Object getById(String id) throws CommandException, NotFoundException {
		...
		if (r == null) {
			throw new NotFoundException("Payment receipt item id(" + id + ") not found.");
		}
	...
	public List<Object> get(Query q) {
		...
		List<Object> receipts = HibernateUtils.select("FROM PaymentReceiptItem " + whereSQL, sqlParams, q.getQuery(), limit, offset);
		return receipts;
	}
