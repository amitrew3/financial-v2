...
import com.rew3.payment.invoicepayment.model.BankReconciliation;
...
public class BankReconciliationQueryHandler implements IQueryHandler {
    ...
    public List<Object> getBankReconciliationsInAccountingPeriod(AccountPeriod ap, String billingAccountId) {
