...
public class BankTransaction extends AbstractEntity {
    ...
    @ManyToOne
    private AccountPeriod clearedTransactionPeriod;
    ...
    public AccountPeriod getClearedTransactionPeriod() {
        return clearedTransactionPeriod;
    }

    public void setClearedTransactionPeriod(AccountPeriod clearedTransactionPeriod) {
