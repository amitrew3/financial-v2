...
//        String field = null;
//
//        Rew3DateRange range = PatternMatcher.dateRangeMatch("[2012-12-12T02:12:12.1,2013-12-12T03:02:12.111]");
//
//        System.out.println(range.getStartDate());
//        System.out.println(range.getEndDate());


        Matcher isEqualMatcher = PatternMatcher.isEqualMatch("name-is");
        if (isEqualMatcher.find()) {
            String val = isEqualMatcher.group(2);
    ...
    public static void configureSession(String filePath) {
        File f = null;
        if (filePath != null) {
    ...
    public static synchronized Object save(Object obj, Transaction aTrx, boolean isNew) throws JsonProcessingException {
    ...
    public static List<Object> select(String hql, HashMap<String, Object> params, HashMap<String, Object> requestParams, int limit, int offset) {
        boolean isNewSession = !HibernateUtils.isSessionOpen();
        Session session = null;
        List<Object> results = null;
        Transaction tx = null;
    ...
    public static List<Object> selects(String hql, HashMap<String, Object> params, HashMap<String, String> filterParams, HashMap<String, Object> requestParams) {
        boolean isNewSession = !HibernateUtils.isSessionOpen();
        Session session = null;
        List<Object> results = null;
        Transaction tx = null;
    ...
    private static String filter(String hql, HashMap<String, Object> requestParams, HashMap<String, Object> sqlParams) throws ParseException {
        ...
        for (Map.Entry<String, Object> entry : requestParams.entrySet()) {
            ...
            if (startsWithMatcher.find()) {
                ...
                hql += " AND " + filteredKey + " LIKE " + HibernateUtils.s(requestValue + "%");
            }
            ...
            if (notContainMatcher.find()) {
                ...
                String filteredKey = Rew3StringBuiler.getFilteredKey(field).getValue();
                hql += " AND " + filteredKey + " NOT LIKE " + HibernateUtils.s("%" + requestValue + "%");
            }
            ...
            if (specificDateMatcher.find()) {
                ...
                hql += " AND " + filteredKey + " BETWEEN " + HibernateUtils.s(range.getStartDate().toString()) + " AND " + HibernateUtils.s(range.getEndDate().toString());
            ...
            if (operatorMatch) {
                ...
                hql += " AND " + filteredKey + op + HibernateUtils.s(requestValue);
            ...
            if (operatorMatch && dateFormatMatch) {
                ...
                String op = Parser.getOperator(operator);
                hql += " AND " + filteredKey + op + "date(" + HibernateUtils.s(queryDate);
    ...
    public static <T> List<T> select(String hql, HashMap<String, Object> params, HashMap<String, Object> requestParams, int limit, int offset, T t) {
        Session session = null;
        List<T> results = null;
        Transaction tx = null;
    ...
    private static <T> String filter(String hql, HashMap<String, Object> requestParams, HashMap<String, Object> sqlParams, T t) throws ParseException {
    ...
    public static synchronized Object save(Object obj, ICommand command, boolean isNew) throws JsonProcessingException {
    ...
    public static <T> Object count(String hql, HashMap<String, Object> params, HashMap<String, Object> requestParams, int limit, int offset, T t) {
        boolean isNewSession = !HibernateUtils.isSessionOpen();
        Session session = null;
        Object o = null;
        Transaction tx = null;
    ...
    public static <T> Long count(String hql, HashMap<String, Object> params, HashMap<String, Object> requestParams, T t) {
        Session session = null;
        Object o = null;
        Transaction tx = null;
