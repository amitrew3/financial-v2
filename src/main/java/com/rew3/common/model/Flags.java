...
//        }
   ...
   /* public static Byte convertInputToStatus(Object input) {
    ...
    public enum EntityClassType implements EntityFlags {
        ...
        INVOICE("com.rew3.billing.invoice.model.Invoice"),
        INVOICE_ATTACHMENT("com.rew3.billing.invoice.model.InvoiceAttachment"),
        INVOICE_ITEM("com.rew3.billing.invoice.model.InvoiceItem"),
        INVOICE_REQUEST("com.rew3.billing.invoice.model.InvoiceRequest"),
        NORMAL_USER("com.rew3.billing.normaluser.model.TieredAcp"),
        PAYMENT_OPTION("com.rew3.billing.normaluser.model.PaymentOption"),
        TERMS("com.rew3.billing.invoice.model.PaymentTerm"),
        ...
        SALES("com.rew3.billing.sales.model.Sales"),
        ADDRESS("com.rew3.billing.shared.model.Address"),
        ATTACHMENT("com.rew3.billing.shared.model.Attachment"),
