package com.rew3.finance.accountingperiod;
...
public class AccountingPeriodRequestQueryHandler implements IQueryHandler {

    @Override
    public Object getById(String id) throws CommandException, NotFoundException {
        AccountingPeriodRequest apr = (AccountingPeriodRequest) HibernateUtils.get(AccountingPeriodRequest.class, id);
    ...
    public boolean hasAccountingPeriodRequest(String accountingPeriodId) {
        ...
        List<AccountingPeriodRequest> apRequest = HibernateUtils.select("FROM AccountingPeriodRequest WHERE status =:status AND" +
