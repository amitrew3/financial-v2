...
public class TransactionGcpQueryHandler implements IQueryHandler {
    ...
    public List<Object> get(Query q) {
        ...
        if (q.has("transactionId")) {
            builder.append("AND");
            builder.append(DB.Field.TransactionGcp.TRANSACTION_ID);
            builder.append("= :transactionId ");
            sqlParams.put("transactionId", q.get("transactionId"));
        }
        if (q.has("gcpId")) {
            builder.append("AND");
            builder.append(DB.Field.TransactionGcp.GCP_ID);
            builder.append("= :gcpId ");
            sqlParams.put("gcpId", q.get("gcpId"));
        }
