package com.rew3.commission.gcp;
...
public class GcpQueryHandler implements IQueryHandler {

    @Override
    public Object getById(String id) throws CommandException, NotFoundException {
        Gcp gcp = (Gcp) HibernateUtils.get(Gcp.class, id);
        if (gcp == null) {
            throw new NotFoundException("Gross Commission Plan id(" + id + ") not found.");
        }
        if (gcp.getStatus() == Flags.EntityStatus.DELETED.toString())
