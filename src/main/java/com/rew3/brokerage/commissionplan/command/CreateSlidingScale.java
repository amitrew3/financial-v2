...
public class CreateSlidingScale extends Command implements ICommand {
    public CreateSlidingScale(HashMap<String, Object> data, CommissionPlan plan) throws CommandException, NotFoundException {
        super(data);
    ...
    public CreateSlidingScale(HashMap<String, Object> data, Transaction trx) throws CommandException, NotFoundException {
        super(data, trx);
