package com.rew3.billing.normaluser.model;
...
public class NormalUser extends AbstractEntity {
    ...
    @ManyToOne
    private NormalUser parentNormalUser;
   ...
   /* @Transient
    ...
    public NormalUser getParentNormalUser() {
        return parentNormalUser;
    }

    public void setParentNormalUser(NormalUser parentNormalUser) {
        this.parentNormalUser = parentNormalUser;
    }
