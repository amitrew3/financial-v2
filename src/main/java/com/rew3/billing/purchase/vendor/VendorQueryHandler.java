...
public class VendorQueryHandler implements IQueryHandler {
    ...
    public Object getById(String id) throws CommandException, NotFoundException {
        Vendor rd = (Vendor) HibernateUtils.get(Vendor.class, id);
        if (rd == null) {
    ...
    public List<Object> get(Query q) {
       ...
       /* if (q.has("buyerId")) {
        ...
        List<Object> transactions = HibernateUtils.select("SELECT t FROM NormalUser t " + builder.getValue(), sqlParams, q.getQuery(), limit, offset, new Vendor());
