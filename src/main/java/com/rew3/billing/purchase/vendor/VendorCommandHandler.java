package com.rew3.billing.purchase.vendor;
...
import com.rew3.billing.purchase.vendor.command.*;
import com.rew3.billing.purchase.vendor.model.Vendor;
...
public class VendorCommandHandler implements ICommandHandler {
    ...
    public static void registerCommands() {
        CommandRegister.getInstance().registerHandler(CreateNormalUser.class, VendorCommandHandler.class);
        CommandRegister.getInstance().registerHandler(UpdateNormalUser.class, VendorCommandHandler.class);
        CommandRegister.getInstance().registerHandler(DeleteNormalUser.class, VendorCommandHandler.class);
        CommandRegister.getInstance().registerHandler(CreateBulkNormalUser.class, VendorCommandHandler.class);
        CommandRegister.getInstance().registerHandler(UpdateBulkNormalUser.class, VendorCommandHandler.class);
        CommandRegister.getInstance().registerHandler(DeleteBulkNormalUser.class, VendorCommandHandler.class);
    }
