package com.rew3.billing.purchase.bill;
...
public class BillQueryHandler implements IQueryHandler {
    ...
    public List<Bill> getDueableInvoices() {
        HashMap<String, Object> sqlParams = new HashMap<>();
        sqlParams.put("paidStatus", Flags.InvoicePaymentStatus.PAID);
        sqlParams.put("overdueStatus", Flags.InvoiceDueStatus.OVERDUE);
        List<Bill> bills = HibernateUtils
    ...
    public List<Bill> getPendingJournalInvoices() throws CommandException {
        ...
        for (Map<String, Object> qRow : queryResult) {
            ...
            Bill inv = (Bill) HibernateUtils.get(Bill.class, invoiceId);
            bills.add(inv);
        }
