...
import com.rew3.common.api.BaseAction;
...
public class InvoiceViewResource extends BaseAction {
	...
	public String viewInvoice() throws CommandException, NotFoundException {
		HttpServletRequest request = ServletActionContext.getRequest();

		*/
/*Long id = Parser.convertObjectToLong(this.get_id());
