...
public class CreditNoteQueryHandler implements IQueryHandler {

    @Override
    public Object getById(String id) throws CommandException, NotFoundException {
        DebitNote rd = (DebitNote) HibernateUtils.get(DebitNote.class, id);
        if (rd == null) {
    ...
    public List<Object> get(Query q) {
       ...
       /* if (q.has("buyerId")) {
        ...
        List<Object> transactions = HibernateUtils.select("SELECT t FROM NormalUser t " + builder.getValue(), sqlParams, q.getQuery(), limit, offset, new DebitNote());
