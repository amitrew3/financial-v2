package com.rew3.billing.sale.customer;
...
public class CustomerCommandHandler implements ICommandHandler {
    ...
    public static void registerCommands() {
        CommandRegister.getInstance().registerHandler(CreateNormalUser.class, CustomerCommandHandler.class);
        CommandRegister.getInstance().registerHandler(UpdateNormalUser.class, CustomerCommandHandler.class);
        CommandRegister.getInstance().registerHandler(DeleteNormalUser.class, CustomerCommandHandler.class);
        CommandRegister.getInstance().registerHandler(CreateBulkNormalUser.class, CustomerCommandHandler.class);
        CommandRegister.getInstance().registerHandler(UpdateBulkNormalUser.class, CustomerCommandHandler.class);
        CommandRegister.getInstance().registerHandler(DeleteBulkNormalUser.class, CustomerCommandHandler.class);
    }
    ...
    public void handle(CreateBulkNormalUser c) {
        ...
        try {
            ...
            for (HashMap<String, Object> data : normalusers) {
                ...
                Customer nu = (Customer) command.getObject();
                normalUsers.add(nu);
            }
