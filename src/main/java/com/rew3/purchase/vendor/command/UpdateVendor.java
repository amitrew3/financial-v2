...
public class UpdateVendor extends Command implements ICommand {
	public UpdateVendor(HashMap<String, Object> data) throws CommandException {
		super(data);
	...
	public UpdateVendor(HashMap<String, Object> data, Transaction trx) throws CommandException {
		super(data,trx);
		this.validationSchema = "normaluser/update";
		if(!this.validate()){
			throw new CommandException("invalid");
