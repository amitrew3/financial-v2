...
public class CreateCustomer extends Command implements ICommand {
	public CreateCustomer(HashMap<String, Object> data) throws CommandException {
		super(data);
	...
	public CreateCustomer(HashMap<String, Object> data, Transaction trx) throws CommandException {
		super(data,trx);
		this.validationSchema = "normaluser/create";
		boolean valid=this.validate();
		if(!valid){
