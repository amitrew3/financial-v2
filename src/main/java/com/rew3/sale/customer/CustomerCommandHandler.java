...
public class CustomerCommandHandler implements ICommandHandler {
    ...
    public void handle(CreateBulkCustomer c) {
        Transaction trx = c.getTransaction();
        ...
        try {
            ...
            for (HashMap<String, Object> data : normalusers) {
                ICommand command = new CreateCustomer(data, trx);
    ...
    public void handle(DeleteBulkCustomer c) {
        Transaction trx = c.getTransaction();
        ...
        try {
            ...
            for (Object o : ids) {
                ...
                String id = (String) o;
                map.put("id", id);
                CommandRegister.getInstance().process(new DeleteCustomer(map, trx));
            }
