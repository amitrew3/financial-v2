...
public class AccountCodeQueryHandler implements IQueryHandler {
   ...
   /* public AccountingCode getAccountingCode(Long ownerId, AccountingHead head,
    ...
    public Account getAccountingCode(Long ownerId, AccountingHead head, Long entityId, EntityType entityType) {
   ...
   /* public EntityCode getUserCode(Long userId) {
    ...
    public Account getAccountingCode(String ownerId, String codeName,
                                     AccountingCodeSegment segment) {
        String whereSQL = " WHERE 1=1 ";
        HashMap<String, Object> sqlParams = new HashMap<>();
