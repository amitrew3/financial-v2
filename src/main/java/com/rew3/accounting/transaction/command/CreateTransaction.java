...
public class CreateTransaction extends Command implements ICommand {
	public CreateTransaction(HashMap<String, Object> data) {
		super(data);
	}

	public CreateTransaction(Integer entryNumber, Timestamp date, AccountingCodeSegment segment, Account code,
