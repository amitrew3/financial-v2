...
public class TransactionQueryHandler implements IQueryHandler {
    ...
    public Object getById(String id) throws CommandException, NotFoundException {
        Transaction aj = (Transaction) HibernateUtils.get(Transaction.class, id);
    ...
    public List<Transaction> getByAccountingCodeId(Long accountingCodeId) {
        ...
        List<Transaction> aTransactions = HibernateUtils.select("From AccountingJournal" + whereSQL, sqlParams);
