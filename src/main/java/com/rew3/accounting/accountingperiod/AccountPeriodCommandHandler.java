...
import com.rew3.accounting.accountingperiod.model.AccountPeriodRequest;
...
*/
    ...
    public void handle(CreateAccountingPeriodRequest c) throws NotFoundException, CommandException, JsonProcessingException {
        // HibernateUtils.openSession();
        Transaction trx = c.getTransaction();
        AccountPeriodRequest apr = new AccountPeriodRequest();
        ...
        try {
            ...
            if (c.has("accountingPeriodId")) {
                ...
                apr.setAccountPeriod(accountPeriod);
            ...
            apr = (AccountPeriodRequest) HibernateUtils.save(apr, trx);
            c.setObject(apr);
    ...
    public void handle(AcceptAccountingPeriodRequest c) throws Exception {
        ...
        Transaction trx = c.getTransaction();
        String id = (String) c.get("id");
        AccountPeriodRequest apr = (AccountPeriodRequest) new AccountPeriodRequestQueryHandler().getById(id);
        HashMap<String, Object> data = new HashMap<>();
        data.put("id", apr.getAccountPeriod().get_id());
        ...
        AccountPeriod ap = (AccountPeriod) reopenCommand.getObject();
        ...
        try {
            ...
            List<Object> brs = new BankReconciliationQueryHandler().getBankReconciliationsInAccountingPeriod(apr.getAccountPeriod(), apr.getBillingAccount().get_id());
            for (Object o : brs) {
